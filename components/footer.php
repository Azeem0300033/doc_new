...
<footer class="bg-dark text-light">
                ...
                <div class="col-md-3 col-sm-6 equal-height item">
                    <div class="f-item twitter-widget">
                        ...
                        <ul>
                            ...
                            <li class="mt-10">
                                <a href="hosptial.php">Hospital</a>
                            </li>
                            ...
                            <li class="mt-10">
                                <a href="Que.php">Queue Management</a>
                            </li>
                    ...
                    <div class="f-item contact">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <p>Phone <span>042-32500988</span></p>
                            </li>
                            <li>
                                <i class="fas fa-envelope"></i>
                                <p>Email <span><a href="#">support@validtheme.com</a></span></p>
                            </li>
                        </ul>
    ...
    <div class="footer-bottom bg-dark text-light">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p>&copy; Copyright 2023. All Rights Reserved by <a href="#">Lightningitsolution</a></p>
                </div>
