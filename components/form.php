                        ...
                        <div class="form-area">
                            ...
                            <div class="cols" style="margin-top: 10px!important; " >
                                <div class="input-field city-dropdownn">
                                    ...
                                    <select name="city" id="form-city" class="city_select form-control chosen-select input-city-select select2-dropdown dropdown_city_select" style="border: none;" >
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="form-city" class="city_select form-control chosen-select input-city-select select2-dropdown dropdown_city_select" style="border: none;" >
