...
<main>
    ...
    <section class="demo-wrap">
        ...
        <div class="container-fluid" style=" padding-bottom: 8px; background-image: url(assets/img/b2b/form.webp); background-size: cover;background-repeat: no-repeat; height: 568px!important;>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <form style="border: 1px solid #b7b7b7; box-shadow: 1px 4px 12px 12px rgb(164,164,164); padding-top: 20px; padding-bottom: 20px; background-color: #ffffff" >
                        <div class="row">
                            <div class="col-md-12">
                                <h2 style="text-align: center"> <i>GET DEMO</i></h2>
                            </div>
                        </div>
                        ...
                        <div class="row" style="padding: 8px!important;" >
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-field doctors hide" >
                                    <label >
                                ...
                                <div class="input-field pharma_type hide" >
                                    <label >
                                        <strong>Type</strong>
                                    </label>
                                ...
                                <div class="input-field lab_type hide">
                                    <label >
                                        <strong>Type</strong>
                                    </label>
                        ...
                        <div class="cols" style="margin-top: 10px; margin-left: 45%;" >
                            <button id="request-demo-id" type="submit" name="submit" class="button"
                                    onclick="myFunctionShow(event,this)">
                                Request Demo
                            </button>
                        </div>
